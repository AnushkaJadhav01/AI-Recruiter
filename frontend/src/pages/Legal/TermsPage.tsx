      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
        ...
        <div className="mb-12">
          ...
          <p className="text-base text-[#6B7280] leading-relaxed max-w-2xl">
            Please read these Terms and Conditions carefully before using the Candidate360 platform. By accessing or using our services, you agree to be bound by these terms.
          </p>
        ...
        <div className="bg-white rounded-2xl border border-[#F1DDD2] shadow-sm p-8 sm:p-12">
          ...
          <Section title="1. Acceptance of Terms">
            <p>By creating an account or using Candidate360, you confirm that you are at least 16 years of age and have the legal capacity to enter into these Terms. If you are using Candidate360 on behalf of an organization, you represent that you have authority to bind that organization to these Terms.</p>
          </Section>

          <Section title="2. Description of Service">
            <p>Candidate360 is an AI-native recruitment platform that enables recruiters to discover, evaluate, and rank candidates using autonomous AI agents, skill evidence graphs, and structured Candidate DNA profiles.</p>
            <p>Candidates may use Candidate360 to upload resumes, connect professional profiles, and receive personalized job recommendations and skill analysis.</p>
          </Section>
          ...
          <Section title="3. Account Registration">
            ...
            <p>You agree to notify us immediately at <a href="mailto:support@candidate360.ai" className="text-[#F97316] font-semibold hover:underline">support@candidate360.ai</a> if you suspect any unauthorized access to your account.</p>
          </Section>
          ...
          <Section title="4. Acceptable Use">
            ...
            <ul className="list-disc pl-5 space-y-1.5">
              ...
              <li>Attempt to reverse-engineer, scrape, or extract data from the Candidate360 platform.</li>
              ...
              <li>Use Candidate360 for any unlawful purpose or in violation of applicable employment laws.</li>
            </ul>
          </Section>

          <Section title="5. AI-Generated Content">
            <p>Candidate360 uses artificial intelligence to generate candidate scores, skill summaries, evidence graphs, and match recommendations. These outputs are provided as decision-support tools and should not be the sole basis for hiring decisions.</p>
            <p>Candidate360 does not guarantee the accuracy, completeness, or fitness for any particular purpose of AI-generated content. Recruiters remain solely responsible for their hiring decisions.</p>
          </Section>

          <Section title="6. Intellectual Property">
            <p>All platform features, design, code, trademarks, and AI models are the exclusive property of Candidate360 Technologies. You are granted a limited, non-exclusive, non-transferable license to use the platform for its intended purposes.</p>
            <p>You retain ownership of content you upload (e.g., resumes, job descriptions). By uploading content, you grant Candidate360 a limited license to process that content to provide our services.</p>
          </Section>

          <Section title="7. Subscription and Billing">
            <p>Certain features of Candidate360 require a paid subscription. All fees are stated in USD and are non-refundable except as required by law or as described in our refund policy. We reserve the right to modify pricing with 30 days' advance notice.</p>
          </Section>
          ...
          <Section title="9. Limitation of Liability">
            <p>To the maximum extent permitted by law, Candidate360 Technologies shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of the platform, including but not limited to lost profits, data loss, or unsuccessful hires.</p>
          ...
          <Section title="10. Disclaimer of Warranties">
            <p>The Candidate360 platform is provided "as is" and "as available" without warranties of any kind, either express or implied, including but not limited to merchantability, fitness for a particular purpose, or non-infringement.</p>
          </Section>
          ...
          <Section title="13. Contact">
            ...
            Email: <a href="mailto:legal@candidate360.ai" className="text-[#F97316] hover:underline font-semibold">legal@candidate360.ai</a><br />
