            ...
            myJobs.map((job, idx) => (
              ...
              >
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4">
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-2 w-full sm:w-auto border-t border-gray-100 sm:border-t-0 pt-2 sm:pt-0 shrink-0">
                ...
                {/* Actions + timestamp */}
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-3 border-t border-gray-150/45">
                  ...
                  <div className="flex flex-wrap gap-2 w-full sm:w-auto">
                    <button
                      ...
                      className="flex-1 sm:flex-none justify-center flex items-center gap-1.5 px-3 py-2 bg-red-50 hover:bg-red-100 text-red-600 text-xs font-semibold rounded-lg transition-colors border border-red-100"
                    >
                      Delete
                    </button>
                    <button
                      onClick={() => navigate('/upload-resume')}
                      className="flex-1 sm:flex-none justify-center flex items-center gap-1.5 px-3 py-2 bg-gray-100 hover:bg-gray-200 text-[#2D2A26] text-xs font-semibold rounded-lg transition-colors"
                    >
                      <FiUpload className="w-3 h-3" /> Upload CVs
                    </button>
                    <button
                      onClick={() => navigate('/discovery')}
                      className="flex-1 sm:flex-none justify-center flex items-center gap-1.5 px-3 py-2 bg-[#F97316] hover:bg-[#EA580C] text-white text-xs font-semibold rounded-lg transition-colors"
                    >
